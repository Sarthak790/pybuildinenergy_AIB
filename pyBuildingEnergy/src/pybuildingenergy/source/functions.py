...
def dynamic_window_properties(g_normal, u_nominal, alpha_sol_t, phi_sol_t, beta_k_t, gamma_k_t, wind_speed_m_s):
    ...
    # 2. Calculate Cosine of Incidence Angle (theta)
    ...
    if cos_theta <= 0:
        ...
        # Incident Angle Modifier (IAM) - Empirical curve
        # Highly relevant for Australia: reflects intense grazing summer sun (>60 deg)
    ...
    if u_nom > 0:
        ...
        # Calculate real-time exterior convective heat transfer coefficient
